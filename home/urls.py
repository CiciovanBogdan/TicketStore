...
urlpatterns = [
    ...
    path('search-hospitality/', views.search_hospitality_payed, name='search_hospitality_payed'),
    path('search-hospitality-real/', views.search_hospitality_vip, name='search_hospitality_vip'),
